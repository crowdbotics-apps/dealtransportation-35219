...
## Project Structure
    ...
    ├── dealtransportation_35219  # Django project configurations
...
1. Clone this repo and `cd dealtransportation_35219`
...
2. Clone this repo and `cd dealtransportation_35219`
